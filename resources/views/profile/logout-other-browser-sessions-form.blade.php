<x-jet-action-section>
    ...
    <x-slot name="description">
        <div dir="rtl">
            {{ __('از بقیه مرورگر ها، از حسابتان خارج شوید') }}
        </div>
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600" dir="rtl">
            {{ __('در صورت لزوم میتوانید از همه مرورگر های دیگر در همه دستگاه های دیگر خارج شوید. بعضی از مرورگرهای اخیرتان در زیر لیست شده. اگرچه ممکن است این لیست خسته کننده باشد. اگر احساس در معرض خطر بودن میکنید، باید رمزتان را نیز عوض کنید.') }}
        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('لطفا برای تایید خروج از بقیه مرورگر ها کلمه عبورتان را وارد کنید') }}
